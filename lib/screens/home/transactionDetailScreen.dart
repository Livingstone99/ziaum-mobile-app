...
class _TransactionDetailScreenState
  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      if (transactionModel.mobileMoneyStatus == "success")
        return ref.read(transactionProvider.notifier).checkTransactionStatus({
          "disburse_invoice": transactionModel.disburseId,
          // "disburse_id": transactionModel.transactionId
        });
      await ref
...
// await transaction.
  ...
  bool _showDetails = false; // State to manage visibility of details
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        onRefresh: () async {
          ...
          //     .read(transactionProvider.notifier)
          //     .getTransactionDetails(ref.read(transactionIdProvider)),
          ref.read(transactionProvider.notifier).checkTransactionStatus({
            "disburse_invoice": transactionModel.disburseId,
            // "disburse_id": transactionModel.transactionId
          });
          // ],);
                            ...
                            Center(
                              child: ElevatedButton(
                                onPressed: () {
                                  setState(() {
                                    _showDetails =
                                        !_showDetails; // Toggle visibility
                                  });
                                },
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    ...transactionModel.responseData!.entries
                                        .map((entry) {
                                      return Text(
